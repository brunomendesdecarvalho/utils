...
bm_strings: a list of string functions:

1 - is_letter: receive a char, returns True if its a letter, otherwise, returns False;

2 - is_number: receive a char, returns True if its a number, otherwise, returns False;

3 - is_upper: receive a char, returns True if its upper case, False if its not;

4 - is_lower: receive a char, returns True if its lower case, False if its not;
